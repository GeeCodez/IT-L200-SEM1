...
**TYPES OF DATA**
* **Structured data**: They have a predefined model and are organized
* **Unstructured data**: Unorganized . E.g: audio, videos.
...
* It provides a large storage space compared to the file management system
* It provides backup options for stored data