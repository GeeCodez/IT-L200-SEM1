...
* **Subtypes**: a subgrouping of the entities in an entity type that is derived from supertype that is meaningful to the organization. eg. persons can be classified as students or lectures.
